...
/**
 * Mailchimp library. Handles subscription of users into a specific Mailchimp list.
 *
 * @package    Mailchimp
 * @author     Regis Freyd
 */
class Mailchimp_Core {
	    ...
	    function __construct($secure=false) 
		{
	        ...
	        $this->api_key = Kohana::config('mailchimp.api_key');
	    }
	     ...
	     * @param array $options a hash of the standard options for this campaign
   	     * @param array $content the content for this campaign
	    ...
	    */
	     ...
	     * @returnf array timewarp If this campaign was a Timewarp campaign, an array of stats from each timezone for it.
	     */
	     ...
	     * @returnf array errors Array of error arrays
	     */
	     ...
	     * @returnf array data the data for each member
	     */
	     ...
	     * @returnf int success the number of subscribers successfully found on the list
	     * @returnf int errors the number of subscribers who were not found on the list
	     * @returnf array data an array of arrays
	     */
	     ...
	     * @returnf array data the actual data for each reports
	     */
